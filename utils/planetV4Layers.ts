...
const planetDefBySource = new globalThis.Map<string, PlanetLayerDef>(
  PLANET_V4_LAYERS.map((d) => [d.sourceLayer, d])
)
...
export function getPlanetMapLayerInsertBeforeId(map: MapLibreMap, mapLayerId: string): string | undefined {
...
export function reorderPlanetBaseLayersOnMap(map: MapLibreMap, insertBefore?: string): void {
